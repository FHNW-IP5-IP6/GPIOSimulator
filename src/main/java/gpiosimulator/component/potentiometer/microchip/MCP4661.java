...
public class MCP4661 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (true for MCP4661)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (false for MCP4661)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A, B for MCP4661)
	 */
	@Override
