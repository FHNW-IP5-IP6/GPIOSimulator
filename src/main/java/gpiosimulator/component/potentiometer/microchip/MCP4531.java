...
public class MCP4531 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (false for MCP4531)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (false for MCP4531)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A only for MCP4531)
	 */
	@Override
