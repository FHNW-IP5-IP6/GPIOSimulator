...
public class MicrochipPotentiometerDeviceController {
	...
	/**
	 * Returns the status of the component according EEPROM and WiperLocks.
	 *
	...
	/**
	 * Receives the current wiper's value from the component.
	 *
	 * @param channel Which wiper
	...
	/**
	 * Sets the wiper's value in the component.
	 *
	 * @param channel Which wiper
	...
	/**
	 * Fetches the terminal-configuration from the component for a certain channel.
	 *
	...
	public DeviceControllerTerminalConfiguration getTerminalConfiguration(
		...
		// read configuration from component
	...
	/**
	 * Sets the given terminal-configuration to the component.
	 *
	...
	public void setTerminalConfiguration(final DeviceControllerTerminalConfiguration config)
		...
		// read current configuration from component
		...
		// write new configuration to component
		write(memAddr, tcon);
	...
	/**
	 * Enables or disables the component's write-protection.
	 * <p>
	 * Hint: This will only work using the &quot;High Volate Command&quot; (see 3.1).
	 *
	...
	private int read(final byte memAddr) throws IOException {
		...
		// ask component for reading data - see FIGURE 7-5
	...
	/**
	 * Writes 9 bits of the given value to the component.
	 *
	...
	private void write(final byte memAddr, final int value) throws IOException {
		...
		// ask component for setting a value - see FIGURE 7-2
		byte cmd = (byte) ((memAddr << 4) | CMD_WRITE | firstBit);

		// 7 bits of value
		byte data = (byte) (value & 0x00FF);

		// write sequence of cmd and data to the component
	...
	/**
	 * Writes n (steps) bytes to the component holding the wiper's address
	...
	private void increaseOrDecrease(final byte memAddr,
		...
		// ask component for increasing or decrease - see FIGURE 7-7
		...
		// write sequence to the component
		i2cDevice.write(sequence, 0, sequence.length);
