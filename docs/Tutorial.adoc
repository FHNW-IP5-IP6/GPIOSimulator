...
* *State 0:* ist Button gedrückt ? goto state 1 : thread.sleep(100)
* *State 1:* ist Distanz zwischen 1m und 2m ? led strip green, goto state 2 : led strip red
* *State 2:* countdown laufen lassen. auf display anzeigen & stepper motor hinab lassen & buzzer beep
* *State 3:* led strip flash & bild machen & lcd anzeigen & motor aufrollen
