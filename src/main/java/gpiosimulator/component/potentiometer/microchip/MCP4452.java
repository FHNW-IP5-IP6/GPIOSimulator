...
public class MCP4452 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (false for MCP4452)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (true for MCP4452)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A, B, C and D for MCP4452)
	 */
	@Override
