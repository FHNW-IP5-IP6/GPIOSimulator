package gpiosimulator.component.potentiometer.microchip.impl;

import gpiosimulator.component.ComponentBase;
import gpiosimulator.component.potentiometer.microchip.*;
...
/**
 * Abstract Pi4J-component for MCP45XX and MCP46XX ICs.
 *
 * @see gpiosimulator.component.potentiometer.microchip.MCP4561
 * @see gpiosimulator.component.potentiometer.microchip.MCP4651
...
public abstract class MicrochipPotentiometerBase
	...
	/**
	 * The value which is used for address-bit if the component's package
	 ...
	 * @param pinA2 Whether the component's address pin A2 (if available) is high (true) or low (false)
	 * @param channel Which of the potentiometers provided by the component to control
	...
	protected MicrochipPotentiometerBase(
		...
		if (channel == null) {
			throw new RuntimeException(
					...
					+ "specifying a channel is mandatory! If the component "
		...
		if (!isChannelSupportedByDevice(channel)) {
			throw new RuntimeException(
					"For building a Microchip-potentiometer "
					+ "only channels supported by the underlying component "
		...
		// build the underlying Pi4J-component
	...
	protected void initialize(final int initialValueForVolatileWipers) throws IOException {
		...
		if (isCapableOfNonVolatileWiper()) {
			...
			// the component's volatile-wiper will be set to the value stored
	...
	/**
	 * @return Whether component is capable of non volatile wipers
	 */
    @Override
	public abstract boolean isCapableOfNonVolatileWiper();

	/**
	 * @return All channels supported by the underlying component
	 */
    @Override
	...
	protected static int buildI2CAddress(
		...
		// dynamic component if component knows pin A0
		if (pinA0) {
			i2cAddress |= 0b0000001;
		}

		// dynamic component if component knows pin A1
		if (pinA1) {
			i2cAddress |= 0b0000010;
		}

		// dynamic component if component knows pin A2
		if (pinA2) {
	...
	protected void setNonVolatileMode(final MicrochipPotentiometerNonVolatileMode nonVolatileMode) {
		...
		if (!isCapableOfNonVolatileWiper()
			...
			throw new RuntimeException("This component is not capable of non-volatile wipers."
	...
	public void decrease(final int steps) throws IOException {
		...
		// if lower-boundary then set value in component to ensure sync
	...
	public void increase(final int steps) throws IOException {
		...
		// if upper-boundary then set value in component to ensure sync
		// and for a large number of steps it is better to set a new value
	...
	/**
	 * @return The component- and wiper-status
	 * @throws IOException Thrown if communication fails or component returned a malformed result
	 */
    @Override
	 ...
	 * do not point to a specific component/channel.
	 *
	...
	public boolean equals(final Object obj) {
		...
		// because the do not point to a specific component/channel
		return true;
	 ...
	 * @return Whether the given channel is supported by the underlying component
	 */
    @Override
