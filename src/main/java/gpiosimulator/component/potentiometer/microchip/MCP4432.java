...
public class MCP4432 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (false for MCP4432)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (true for MCP4432)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A, B, C and D for MCP4432)
	 */
	@Override
