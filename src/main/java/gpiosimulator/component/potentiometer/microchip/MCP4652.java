...
public class MCP4652 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (false for MCP4652)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (true for MCP4652)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A, B for MCP4652)
	 */
	@Override
