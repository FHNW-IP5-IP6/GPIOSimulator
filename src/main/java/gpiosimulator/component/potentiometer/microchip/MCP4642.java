...
public class MCP4642 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (true for MCP4642)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (true for MCP4642)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A, B for MCP4642)
	 */
	@Override
