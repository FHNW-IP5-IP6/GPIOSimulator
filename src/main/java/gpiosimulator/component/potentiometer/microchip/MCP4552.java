...
public class MCP4552 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (false for MCP4552)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (true for MCP4552)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A only for MCP4552)
	 */
	@Override
