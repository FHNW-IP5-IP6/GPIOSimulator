package gpiosimulator.component.servo.impl;
...
import gpiosimulator.component.servo.ServoDriver;
import gpiosimulator.component.servo.ServoProvider;
 ...
 * constructor assumes UART control of the default component at address 12 at 9600 Baud.
 *
...
public class MaestroServoProvider implements ServoProvider {
    ...
    // Maestro "component number", useful if daisy-chaining multiple controllers.
