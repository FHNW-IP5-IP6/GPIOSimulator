...
=== Installation vom Raspbian 
Als erstes benötigen wir das Betriebssystem Raspbian, welches wir auf die Mini SD-Karte aufsetzen möchten.

Dafür müssen Sie sich das Image downloaden, welches Sie installieren möchten. Besuchen Sie hierfür die Website: + 
...
Extrahieren sie dann diesen Ordner. Der Ordner enthält die img-Datei, die wir später benötigen.
