package gpiosimulator.component.potentiometer;

import gpiosimulator.component.Component;
...
public interface Potentiometer extends Component {
	...
	/**
	 * @return The maximum wiper-value supported by the component
	 */
	int getMaxValue();

	/**
	 * @return Whether the component is a potentiometer or a rheostat
	 */
	boolean isRheostat();
	 ...
	 * @throws IOException If communication with the component fails
	 * @see #getMaxValue()
	 */
	 ...
	 * avoid accessing the component to often.
	 *
