...
package gpiosimulator.component.lcd.impl;

//~--- non-JDK imports --------------------------------------------------------

import gpiosimulator.component.lcd.LCD;
import gpiosimulator.component.lcd.LCDBase;
...
public class I2CLcdDisplay extends LCDBase implements LCD {
    ...
    /**
     * @param backlight the backlight to set
     * @param immediate optionally update the component immediately
     */
