...
public class MCP4541 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether component is capable of non volatile wipers (true for MCP4541)
	 */
	@Override
	...
	/**
	 * @return Whether this component is a potentiometer or a rheostat (false for MCP4541)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying component (A only for MCP4541)
	 */
	@Override
